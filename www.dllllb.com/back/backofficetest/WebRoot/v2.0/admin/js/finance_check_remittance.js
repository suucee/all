...
$(function() {
	finance_init(
		"../admin/_check_withdrawal.html","汇款",
		function(){
			complianceCheckWithdrawal = new ComplianceCheckWithdrawal();
		},
		function(){
			finance_remittance_check('REMITTED');
		},
		function(){
			finance_remittance_check('REJECTED');
		}
	);
});
...
function finance_remittance_check  (scheme) {
...
function refreshWithdrawalInfo(){
	if(complianceCheckWithdrawal!=null){
		complianceCheckWithdrawal.getOneWithdrawal();
	}
}