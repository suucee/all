...
MT4Order.prototype = {
	init : function() {
		$.jsonRPC.request("adminRiskService.getMt4OrdersCountUser", {
			params : [],
			success : function(result) {
				...
				for (var i = 0; i < list.length; i++) {
					...
					html += '<tr>' 
					+ '<td>' + (the.userId==null?"":"<a href='user_detail.html?id="+the.userId+"'>")+(the.userName==null?"--":the.userName)+(the.userId==null?"":"</a>")+ ' </td>' 
